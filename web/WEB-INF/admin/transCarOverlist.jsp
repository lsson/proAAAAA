...
<body>
    ...
    <div id="maintip"><strong>位置：</strong>已到站信息列表</div></div>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
        	<td colspan="2">
        	<a href="./TransCarServlet?action=over&currPage=1&opr=first">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
        	<a href="./TransCarServlet?action=over&currPage=${pages.currPage }&opr=prev">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
        	<a href="./TransCarServlet?action=over&currPage=${pages.currPage }&opr=next">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
        	<a href="./TransCarServlet?action=over&currPage=${pages.pageCount }&opr=last">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;
        	第${pages.currPage }页&nbsp;&nbsp;&nbsp;&nbsp;
         	共${pages.pageCount }页&nbsp;&nbsp;&nbsp;&nbsp;
         	到站的共${pages.rowCount }趟车&nbsp;&nbsp;&nbsp;&nbsp;
        	</td>
        </tr>
        <tr>
            <td  colspan="2">
