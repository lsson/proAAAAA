...
<body>
	...
	<form action="./TransCarServlet?action=updatesave&currPage=1&opr=first" method="post" name="form1" onsubmit="return check();">
    	...
    	<table align="center" border="1" cellpadding="2" cellspacing="1">
    		...
    		<tr>
    			...
    			<td><input type="text" name="sendTime"   id="d_sr" cssClass="easyui-datebox"  value="${transCar.sendTime }"><font size="2" color="red">格式:2008-8-8</font>
    			</td>
    			<td>&nbsp;</td>
    		</tr>
    		<tr>
