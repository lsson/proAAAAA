...
<body>
    ...
    <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <form action="./SendTypeServlet?action=updatesave&currPage=1&opr=first" method="post" name="form1" onsubmit="return check();">
            	<input type="hidden" name="sendTypeId" value="${send.sendTypeId }"/>
            <table width="70%" border="0" align="left" cellpadding="2" cellspacing="1" >
			  <tr>
			    ...
			    <td class="STYLE1"  style="BORDER-BOTTOM: #c1dad7 1px solid"><input type="text" name="sendTypeName" value="${send.sendTypeName }"></td>
			  </tr>
			   <tr>
